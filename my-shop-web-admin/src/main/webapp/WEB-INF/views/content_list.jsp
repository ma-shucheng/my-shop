                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="/content/form" type="button" class="btn btn-outline">确认</a>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
                            ...
                            <div class="modal modal-danger fade" id="modal-danger">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">关闭</button>
                                            <button type="button" class="btn btn-outline" data-dismiss="modal" onclick="App.deleteMulti('/content/delete')">确认</button>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
                        ...
                        <div class="box-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <c:forEach items="${tbContents}" var="tbContent">
                                    <tr>
                                        <!--为每个选择框分配编号-->
                                        <td><input type="checkbox" class="flat-red" id="${tbContent.id}"></td>
                                        <td>${tbContent.id}</td>
